...
import 'package:smart_lock_app/screens/settings/change_password/change_password_notifier.dart';
...
class ChangePasswordScreen extends StatelessWidget {
  ...
  Widget _buildBody(BuildContext context, ChangePasswordNotifier notifier) {
    return Scaffold(
                  ...
                  children: [
                    ...
                    _passwordField(
                      ...
                      suffixIcon: IconButton(
                        ...
                        icon: Icon(
                          notifier.isCurrentPasswordVisible
  ...
  Widget _strengthIndicator(ChangePasswordNotifier notifier) {
    return Container(
      width: double.infinity,
  ...
  Widget _saveButton(BuildContext context, ChangePasswordNotifier notifier) {
    return SizedBox(
      width: double.infinity,
      height: 46.h,
